package com.ecommerce.generic.listenerutilities;
...
public class ListenerUtility implements ITestListener, ISuiteListener, IRetryAnalyzer {
	...
	public void onStart(ISuite suite) {
		...
		spark.config().setDocumentTitle("SwagLab Execution Reports");
		spark.config().setReportName("SwagLab Module Report");
